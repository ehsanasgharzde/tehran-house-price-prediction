...
TOPATH = r"C:\Users\Klap.ir\Desktop\price-prediction-machine-learning-python\results\regression\sgd-regressor.xlsx"
...
result = pandas.DataFrame({
    "algorithm": ["SGD Regressor" for i in range(len(xtest))],
