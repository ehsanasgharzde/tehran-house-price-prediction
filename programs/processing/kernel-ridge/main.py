...
TOPATH = r"C:\Users\Klap.ir\Desktop\price-prediction-machine-learning-python\results\regression\kernel-ridge.xlsx"
...
result = pandas.DataFrame({
    "algorithm": ["Kernel Ridge" for i in range(len(xtest))],
