...
TOPATH = r"C:\Users\Klap.ir\Desktop\price-prediction-machine-learning-python\results\regression\linear-regression.xlsx"
...
result = pandas.DataFrame({
    "algorithm": ["Linear Regression" for i in range(len(xtest))],
    ...
    "prediction": [prediction[i][0] for i in range(len(xtest))],
