...
TOPATH = r"C:\Users\Klap.ir\Desktop\price-prediction-machine-learning-python\results\regression\lgbm-regressor.xlsx"
...
result = pandas.DataFrame({
    "algorithm": ["LGBM Regressor" for i in range(len(xtest))],
