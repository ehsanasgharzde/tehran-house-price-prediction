...
TOPATH = r"C:\Users\Klap.ir\Desktop\price-prediction-machine-learning-python\results\regression\sv-regressor.xlsx"
...
result = pandas.DataFrame({
    "algorithm": ["SV Regressor" for i in range(len(xtest))],
