...
TOPATH = r"C:\Users\Klap.ir\Desktop\price-prediction-machine-learning-python\results\regression\bayesian-ridge.xlsx"
...
result = pandas.DataFrame({
    "algorithm": ["Bayesian Ridge" for i in range(len(xtest))],
