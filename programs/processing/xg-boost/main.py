...
TOPATH = r"C:\Users\Klap.ir\Desktop\price-prediction-machine-learning-python\results\regression\xg-boost-regressor.xlsx"
...
result = pandas.DataFrame({
    "algorithm": ["XGB Regressor" for i in range(len(xtest))],
