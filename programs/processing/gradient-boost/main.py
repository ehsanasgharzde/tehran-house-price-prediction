...
TOPATH = r"C:\Users\Klap.ir\Desktop\price-prediction-machine-learning-python\results\regression\gradient-boosting-regressor.xlsx"
...
result = pandas.DataFrame({
    "algorithm": ["Gradient Boosting Regressor" for i in range(len(xtest))],
